...
public interface HttpRequestMapper {
	...
	@Insert("INSERT INTO http_request(pguid,guid,sort,url,httpMethod,paramType,"
			...
			+ "#{httpRequest.url},#{httpRequest.httpMethod},#{httpRequest.paramType},"
	...
	@Update("update http_request set sort=#{httpRequest.sort},url=#{httpRequest.url},httpMethod=#{httpRequest.httpMethod},paramType=#{httpRequest.paramType}"

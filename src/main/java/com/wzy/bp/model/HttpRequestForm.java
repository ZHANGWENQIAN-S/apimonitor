...
import com.wzy.bp.model.HttpSequence.MonitorType;
...
public class HttpRequestForm {
    ...
    public static HttpRequestForm getHttpRequestForm(HttpSequence s, HttpRequest r) {
        ...
        form.setResponseTime(s.getResponseTime());
        form.setParamType(r.getParamType());
    ...
    private int responseTime;//响应时间报警阈值
